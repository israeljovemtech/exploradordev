...
const FASES = [
  {
    id: '1',
    numero: '01',
    titulo: 'Fotógrafo Explorador',
    descricao: 'Use a câmera para capturar evidências da missão.',
    rota: 'Fase1',
    icone: '📸',
    bloqueada: false,
  },
  ...
  },
  {
    ...
    descricao: 'Agende uma notificação e toque nela para concluir.',
    rota: 'Fase3',
    icone: '📧',
    bloqueada: false,
  },
  {
    id: '4',
    numero: '04',
    titulo: 'Código de Vibração',
    descricao: 'Pressione os botões para sentir vibrações diferentes.',
    rota: 'Level4',
    icone: '📳',
    bloqueada: false,
  },
